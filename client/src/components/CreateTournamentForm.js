...
function CreateTournamentForm({
  ...
  const onSubmit = async (values, actions) => {
    ...
    try {
      await axios.post(url, valuestToSubmit);
        ...
        {({
          ...
          <Form noValidate onSubmit={handleSubmit} className="">
            ...
            <Form.Group className="mb-3" controlId="place">
              ...
              <Form.Control
                className={errors.place && touched.place ? "is-invalid" : ""}
                name="place"
                onChange={handleChange}
                required
                value={values.place}
            ...
            <Form.Group className="mb-3" controlId="place">
              ...
              <Form.Select
                ...
                className={
                  errors.prestige && touched.prestige ? "is-invalid" : ""
                }
                name="prestige"
                onChange={handleChange}
            ...
            <Form.Group className="mb-3" controlId="event_date">
              ...
              <Form.Control
                ...
                name="event_date"
                className={
                  errors.event_date && touched.event_date ? "is-invalid" : ""
                }
                onChange={handleChange}
                required
            ...
            <Form.Group className="mb-3" controlId="surface">
              ...
              >
                ...
                <option value="ARTIFICAL_TURF">ARTIFICAL_TURF</option>
